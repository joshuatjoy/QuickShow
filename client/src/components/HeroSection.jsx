...
const HeroSection = () => {
  ...
  return (
    ...
    px-6 md:px-16 lg:px-36 bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
        ...
        <p className='max-w-md text-gray-300'>After a successful mission, Peter Quill and his team of galactic defenders meet Ego, 
            a celestial being claiming to be Peter's father. However, they discover disturbing facts as 
            they unravel the truth.</p>
